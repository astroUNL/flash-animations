...
package {
	...
	public class BisectingPlanes {
		...
		public function BisectingPlanes(scene:Scene3D) {
			_scene = scene;
		...
		public function onPostUpdate(...ignored):void {
			...
			_fragmentIndex = 0;
			drawPlane(-angle1*Math.PI/180, color1, alpha1, 0.8);
			drawPlane(-angle2*Math.PI/180, color2, alpha2, 0.8);
		}
