...
package edu.unl.astro.starField {
	...
	public interface IPSF extends IEventDispatcher {
		...
		//   placement of the template for a given star's coordinates; for example, if psf's x and y are 0, and
		//   the star's position is (100, 100), then the template for that star will be placed with the 
		//   upper left corner at (100, 100)
