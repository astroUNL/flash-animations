...
package edu.unl.astro.starField {
	...
	final public class EclipsingBinary extends Star {
		...
		public function EclipsingBinary(settingsObj:* = null):void {
			super(settingsObj);
			if (!(settingsObj is Object)) calculateConstants();
		}
		...
		override public function loadSettings(settingsObj:Object):void {
			_callUpdate = false;
		...
		override public function get magnitude():Number {
			// the code used here and in calculateConstans() was copied and adapted from Lightcurve Component II (v010)
